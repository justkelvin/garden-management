...
import { Appointments, Customer } from "@prisma/client";
...
const getDoctorAppointmentsById = catchAsync(async (req: Request, res: Response) => {
    ...
    sendResponse(res, {
        statusCode: 200,
        message: 'Successfully Retrieve apppointments !!',
        success: true,
        data: result
    })
})
...
const getDoctorPatients = catchAsync(async (req: Request, res: Response) => {
    ...
    sendResponse<Customer[]>(res, {
        statusCode: 200,
        message: 'Successfully retrieve patients !!',
        success: true,
        data: result
    })
})
...
const getDoctorInvoices = catchAsync(async (req: Request, res: Response) => {
    ...
    sendResponse(res, {
        statusCode: 200,
        message: 'Successfully retrieve Gardener info !!',
        success: true,
        data: result
    })
})
