                            ...
                            <div className="col-md-6">
                                <div className="invoice-info">
                                    ...
                                    <p className="invoice-details invoice-details-two">
                                        Mr. {data?.appointment?.gardener?.firstName ? `${data?.appointment?.gardener?.firstName} ${data?.appointment?.gardener?.lastName}`: ' Of Clean My Garden'} <br />
                                        {data?.appointment?.gardener?.address ? data?.appointment?.gardener?.address : "London, Europe ,UK,12435"}, {data?.appointment?.gardener?.city && data?.appointment?.gardener?.city},<br />
                                        {data?.appointment?.gardener?.country && data?.appointment?.gardener?.country} <br />
                                    </p>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="invoice-info invoice-info2">
                                    ...
                                    <p className="invoice-details">
                                        {data?.appointment?.customer?.firstName + ' ' + data?.appointment?.customer?.lastName} <br />
                                        {data?.appointment?.customer?.address}, {data?.appointment?.customer?.city} ,<br />
                                        {data?.appointment?.customer?.country} <br />
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="table-responsive">
                                    <table className="invoice-table table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Description</th>
                                                <th className="text-center">Our Fee</th>
