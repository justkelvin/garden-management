            ...
            render: function (data) {
                return (
                    <div className="avatar avatar-sm mr-2 d-flex gap-2">
                        ...
                        <div>
                            <h6 className='text-nowrap mb-0'>{data?.appointment?.gardener?.firstName + ' ' + data?.appointment?.gardener?.lastName}</h6>
                            <p className='form-text'>{data?.appointment?.gardener?.designation}</p>
                        </div>
                    </div>
                )
            }
            ...
            render: function (data) {
                return <>
                    <div className="avatar avatar-sm mr-2 d-flex gap-2">
                        ...
                        <div>
                            <h6 className='text-nowrap mb-0'>{data?.gardener?.firstName + ' ' + data?.gardener?.lastName}</h6>
                            <p className='form-text'>{data?.gardener?.designation}</p>
                        </div>
                    </div>
                </>
            }
