                        ...
                        <div className='d-flex gap-3 justify-content-between'>
                            <div className='d-flex gap-4'>
                                <div className='review-img'>
                                    <img className="" alt="" src={data?.customer?.img ? data?.customer?.img : img} />
                                </div>
                                <div>
                                    <h5 className="text-nowrap text-capitalize">{item?.customer?.firstName + ' ' + item?.customer?.lastName}</h5>
