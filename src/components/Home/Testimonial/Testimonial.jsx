                        ...
                        <div className="card shadow p-3 border-0 my-5" key={item?.id + key} style={{ maxWidth: '600px' }}>
                            <div className='d-flex gap-2'>
                                <div className='review-img'>
                                    {item.customer.img &&<img src={item.customer.img} alt="" className='shadow' />}
                                </div>
                                <div>
                                    <h5 className='text-secondary'>{item?.customer?.firstName + ' ' + item?.customer?.lastName}</h5>
                                </div>
                            </div>
    ...
    return (
        <div className="container" style={{ marginTop: "10rem", marginBottom: "10rem" }}>
            <div className='mb-5 section-title text-center'>
                <h2>TESTIMONIAL</h2>
                <p className='m-0 text-secondary'>What Our Customers Says.</p>
            </div>
