...
export const appointmentApi = baseApi.injectEndpoints({
    endpoints: (build) => ({
        ...
        getPatientAppointments: build.query({
            query: () => ({
                url: `${APPOINTMENT_URL}/customer/appointments`,
                method: 'GET'
            }),
        ...
        getAppointmentedPaymentInfo: build.query({
            query: (id) => ({
                url: `${APPOINTMENT_URL}/customer-payment-info/${id}`,
                method: 'GET'
            }),
            providesTags: [tagTypes.appointments]
        }),
        getDoctorAppointments: build.query({
            query: (arg) => ({
                url: `${APPOINTMENT_URL}/gardener/appointments`,
                method: 'GET',
                params: arg
            }),
            providesTags: [tagTypes.appointments]
        ...
        getDoctorPatients: build.query({
            query: () => ({
                url: `${APPOINTMENT_URL}/gardener/patients`,
                method: 'GET'
            }),
            providesTags: [tagTypes.appointments]
        }),
        getPatientInvoices: build.query({
            query: () => ({
                url: `${APPOINTMENT_URL}/customer/invoices`,
                method: 'GET'
            }),
            providesTags: [tagTypes.appointments]
        }),
        getDoctorInvoices: build.query({
            query: () => ({
                url: `${APPOINTMENT_URL}/gardener/invoices`,
                method: 'GET'
            }),
            providesTags: [tagTypes.appointments]
        })
